...
class WithLossCell(nn.Cell):
    ...
    def construct(self, img, p3_maps,p4_maps,p5_maps):
        preds_p3,preds_p4,preds_p5 = self._backbone(img)
        return self._loss_fn(preds_p3,preds_p4,preds_p5, p3_maps,p4_maps,p5_maps)

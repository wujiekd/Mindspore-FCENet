...
#   --TRAIN_BATCH_SIZE=6 \
#   --config_path='./configs/CTW1500_config.yaml' \
#   --TRAIN_MODEL_SAVE_PATH="./ctw_bs6_card2" \
#   --run_distribute=True > log/ctw_bs6_card2.log 2>&1 &
...
mpirun --allow-run-as-root -n $DEVICE_NUM \
  ...
  --TRAIN_MODEL_SAVE_PATH="./icdar_bs8_card2" \
  --run_distribute=True > log/icdar_bs8_card2.log 2>&1 &
